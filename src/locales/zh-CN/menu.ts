export default {
  ...
  'menu.locust': '压测模块',
  'menu.locust.locustcaselist': '压测case',
  'menu.locust.locustcasedetaile': '压测case详情',
  'menu.locust.locustsuitelist': '压测套件',
  'menu.locust.locustsuitedetaile': '压测套件详情',
  'menu.locust.synclocustsuite': '压测套件更新',
  'menu.locust.createlocustsuite': '创建压测套件',
  ...
  'menu.openapitest.caseplanlist': '接口测试计划',
  ...
  'menu.openapitest.resultlist': '接口测试结果',
  'menu.openapitest.resultdetaile': '接口测试结果详情',
